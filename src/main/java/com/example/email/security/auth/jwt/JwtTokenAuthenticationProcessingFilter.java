...
import com.example.email.security.config.WebSecurityConfig;
...
public class JwtTokenAuthenticationProcessingFilter extends AbstractAuthenticationProcessingFilter {
    ...
    /**
     * JwtTokenAuthenticationProcessingFilter Constructor
     *
     * @param failureHandler (required) Failure handler
     * @param matcher
     */
    @Autowired
